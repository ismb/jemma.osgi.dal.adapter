...
public class WhiteGoodApplianceControlFactory implements ClusterFunctionFactory {
	...
	public ServiceRegistration createFunctionService(IAppliance appliance, Integer endPointId, IAppliancesProxy appliancesProxy) {
		...
		// WARNING: the category depends on Configuration, make sure you use
		// EmptyConfig.xml file is loaded
		switch (getCategory(appliance)) {
		case 37: // It's a Washing machine
			d.put(Function.SERVICE_OPERATION_NAMES, new String[] { "execStartCycle", "execStopCycle", "execPauseCycle", "execOverloadPauseResume", "execOverloadPause",
					"execOverloadWarning" });
			d.put(Function.SERVICE_PROPERTY_NAMES, new String[] { WashingMachine.PROPERTY_CYCLE, WashingMachine.PROPERTY_TEMPERATURE, WashingMachine.PROPERTY_SPIN,
					WashingMachine.PROPERTY_STARTTIME, WashingMachine.PROPERTY_FINISHTIME, WashingMachine.PROPERTY_REMAININGTIME, WashingMachine.PROPERTY_REMOTECONTROL });

			reg = FrameworkUtil
					.getBundle(this.getClass())
					.getBundleContext()
					.registerService(new String[] { Function.class.getName(), WashingMachine.class.getName() },
							new WashingMachineDALApplianceControlAdapter(appliance.getPid(), endPointId, appliancesProxy), d);
			break;
		case 38: // It's the oven
			d.put(Function.SERVICE_OPERATION_NAMES, new String[] { "execStartCycle", "execStopCycle", "execOverloadPauseResume", "execOverloadPause" });
			d.put(Function.SERVICE_PROPERTY_NAMES, new String[] { Oven.PROPERTY_CYCLE, Oven.PROPERTY_TEMPERATURE, Oven.PROPERTY_STARTTIME, Oven.PROPERTY_FINISHTIME,
					Oven.PROPERTY_REMAININGTIME, Oven.PROPERTY_REMOTECONTROL });

			reg = FrameworkUtil
					.getBundle(this.getClass())
					.getBundleContext()
					.registerService(new String[] { Function.class.getName(), Oven.class.getName() },
							new OvenDALApplianceControlAdapter(appliance.getPid(), endPointId, appliancesProxy), d);
			break;
		case 39: // It's the Fridge
			d.put(Function.SERVICE_OPERATION_NAMES, new String[] {});
			d.put(Function.SERVICE_PROPERTY_NAMES, new String[] { Fridge.PROPERTY_FRIDGETEMPERATURE, Fridge.PROPERTY_FREEZERTEMPERATURE, Fridge.PROPERTY_ECOMODE,
					Fridge.PROPERTY_HOLIDAYMODE, Fridge.PROPERTY_ICEPARTY, Fridge.PROPERTY_SUPERCOOLMODE, Fridge.PROPERTY_SUPERFREEZE });

			reg = FrameworkUtil
					.getBundle(this.getClass())
					.getBundleContext()
					.registerService(new String[] { Function.class.getName(), Fridge.class.getName() },
							new FridgeDALApplianceControlAdapter(appliance.getPid(), endPointId, appliancesProxy), d);
			break;

		case 46: // It's the dishWasher
			d.put(Function.SERVICE_OPERATION_NAMES, new String[] { "execStartCycle", "execStopCycle", "execOverloadPauseResume", "execOverloadPause" });
			d.put(Function.SERVICE_PROPERTY_NAMES, new String[] { Oven.PROPERTY_CYCLE, Oven.PROPERTY_STARTTIME, Oven.PROPERTY_FINISHTIME, Oven.PROPERTY_REMAININGTIME,
					Oven.PROPERTY_REMOTECONTROL });

			reg = FrameworkUtil
					.getBundle(this.getClass())
					.getBundleContext()
					.registerService(new String[] { Function.class.getName(), DishWasher.class.getName() },
							new DishWasherDALApplianceControlAdapter(appliance.getPid(), endPointId, appliancesProxy), d);
			break;
		default:
			// unmanaged appliance
			return null;
