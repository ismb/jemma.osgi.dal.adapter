...
public interface ClusterDALAdapter {
	...
	// function to be implemented to translate an AttributeNotification having
	// its value and the name provided
	// by the factory
	public FunctionData getMatchingPropertyValue(String attributeName, IAttributeValue attributeValue);

	// function to be implemented to translate a notification received from a
	// client cluster
	// returns the FunctionData if the notification is supported by the adapter,
	// null otherwise
